      ...
      {!isLoggedIn ? (
        ...
        >
          ...
          >
            ...
            >
              <path
                d="M21.805 10.023H12.24v3.957h5.484c-.236 1.273-.944 2.351-2.006 3.075v2.554h3.24c1.897-1.747 2.99-4.319 2.99-7.366 0-.719-.065-1.408-.143-2.22Z"
                fill="#4285F4"
              />
              <path
                d="M12.24 23c2.708 0 4.982-.897 6.643-2.437l-3.24-2.554c-.9.603-2.05.959-3.403.959-2.617 0-4.832-1.768-5.625-4.146H3.267v2.635A10.034 10.034 0 0 0 12.24 23Z"
                fill="#34A853"
              />
              <path
                d="M6.615 14.822A5.99 5.99 0 0 1 6.3 12.999c0-.632.11-1.246.315-1.823V8.541H3.267A10.035 10.035 0 0 0 2.2 13c0 1.603.383 3.122 1.067 4.459l3.348-2.637Z"
                fill="#FBBC04"
              />
              <path
                d="M12.24 7.03c1.474 0 2.796.507 3.838 1.503l2.88-2.88C17.218 4.03 14.946 3 12.24 3A10.034 10.034 0 0 0 3.267 8.541l3.348 2.635C7.408 8.798 9.623 7.03 12.24 7.03Z"
                fill="#EA4335"
              />
            </svg>
          ...
          >
            ...
            >
              ...
              >
                ...
                >
                  <path
                    d="M2 20 L14 16 L26 18 L38 8 L50 12 L58 4"
                    stroke="var(--accent)"
                    strokeWidth="2.5"
                    strokeLinecap="round"
            ...
            >
              ...
              >
                ...
                >
                  <path
                    d="M0 24 L0 16 C15 16 20 8 30 10 C40 12 45 4 60 2 L60 24 Z"
                    fill="url(#grad-completion)"
                    opacity="0.2"
                  />
                  <path
                    d="M0 16 C15 16 20 8 30 10 C40 12 45 4 60 2"
                    stroke="#4ade80"
                    strokeWidth="2.5"
                    strokeLinecap="round"
                  />
